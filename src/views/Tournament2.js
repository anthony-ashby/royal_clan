    ...
    <Card className={classes.root}>
      ...
      <CardContent className={classes.cardContent}>
        <Typography variant="body2" component="p">
          This is the Royal Clan Challenge Event! THREE CHALLENGES are laid down
          by the Clan and in partnership with Elite Gaming Channel! The
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent className={classes.cardMoreInfo}>
          <Accordion className={classes.customAccordian}>
            ...
            >
              <Typography className={classes.heading}>General Rules</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <ul>
                  ...
                  <li style={{ paddingTop: 10 }}>
                    Closing Date for these three challenges are: May 16th 12:00
                    AM (Midnight) EST.
                  </li>
                  <li style={{ paddingTop: 10 }}>
                  ...
                  <li style={{ paddingTop: 10 }}>
                    ...
                    (except for herdables which is fine), treasures are allowed,
                    and raiding the AI is allowed.
                  </li>
                  <li style={{ paddingTop: 10 }}>
                    No handicap and/or cheats allowed - please follow the Lobby
                    Setup Rules!
                  </li>
                </ul>
              </Typography>
          ...
          <Accordion className={classes.customAccordian}>
            <AccordionSummary
              ...
              className={classes.customAccordianTitle}
            >
              <Typography className={classes.heading}>Win Condition</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <ul>
                  ...
                  <li style={{ paddingTop: 10 }}>
                    ...
                    nearest minute and lets all members know what time to strive
                    for.
                  </li>
                  <li style={{ paddingTop: 10 }}>
                    Example: If you send in a time of 8:30 for a challenge - we
                    will say the challenge 1 floor time is now beat 9 min!
                  </li>
                </ul>
              </Typography>
            </AccordionDetails>
            ...
            <AccordionDetails>
              <Typography>
                ...
                <ul>
                  ...
                  <li style={{ paddingTop: 10 }}>
                    Must rebel into another country that converts civilians into
                    military unit.
                  </li>
                  <li style={{ paddingTop: 10 }}>
